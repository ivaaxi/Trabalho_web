...
<body>
    ...
    <div class="container-fluid" id="Formulario"> 
        ...
        <div id="Botoes">
            ...
            <a href="cadastrar_produto.html">Novo</a>
            </button>
        </div>
    </div>
    ...
    <?php
        ...
        while($linha = mysqli_fetch_array($aux)) {
    ?>
            ...
            <p>
                ...
                echo "<br>";
                echo "Preço:  ".$linha['preco_produto'];
                echo "<br>";
                echo "Quantidade (UNIDADE):  ".$linha['qtd_produto'];
                echo "<br>";
                echo "<a href='php/deletar_produto.php?nome=".$linha['nome_produto']."'>Excluir</a>";
                echo "&nbsp; &nbsp; &nbsp; &nbsp";
                echo "<a href='#'>Atualizar (Nao funcional)</a>";
