...
<body>
    ...
    ?>
            ...
            <p>
                ...
                echo "<br>";
                echo "Nome:  ".$linha['nome_usuario'];
                echo "<br>";
                echo "ID Usuario:  ".$linha['seq_id_usuario'];
                echo "<br>";
                echo "Senha: CONFIDENCIAL";
                echo "<br>";
                echo "<a href='php/deletar_usuario.php?id=".$linha['seq_id_usuario']."'>Excluir</a>";
                echo "&nbsp; &nbsp; &nbsp; &nbsp";
